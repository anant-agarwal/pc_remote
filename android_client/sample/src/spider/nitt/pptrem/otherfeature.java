 ...
 */
public class otherfeature extends Activity {
    // Debugging
    private static final String TAG = "otherfeature";
   ...
   // private ArrayAdapter<String> mConversationArrayAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
        setContentView(R.layout.otherfeature);
...
//            mOutEditText.setText(mOutStringBuffer);
  ...
  //                  mConversationArrayAdapter.clear();
    ...
    public void ofclk(View v){
    	switch(v.getId()){
    	case R.id.home:
    		Intent Openhom = new Intent("spider.nitt.pptrem.MENU"); 
			startActivity(Openhom);
			break;
    	case R.id.hyb:
    		sendMessage("W");
    		sendMessage("h");
